...
import com.example.matchinii.api.MessagesInterface
import com.example.matchinii.ui.adapters.ChatRoomAdapter
   ...
   var messages = MessagesInterface.create()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /*  roomName=intent.getStringExtra("romee")!!
        ...
        try {
            mSocket = IO.socket("https://matchinichat-production.up.railway.app/")

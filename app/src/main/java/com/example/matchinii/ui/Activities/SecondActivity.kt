...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        register_btn.setOnClickListener {
         ...
         //   map["location"] = mapView!!.location.toString()
            ...
            if (validate()) {
                ...
                val body = MultipartBody.Part.createFormData("Image", getName(getPathFromUri(this.applicationContext, selectedImageUri!!))!!.substring(0,getName(getPathFromUri(this.applicationContext, selectedImageUri!!))!!.length), reqfile)
